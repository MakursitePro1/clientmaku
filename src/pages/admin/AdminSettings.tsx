...
const defaultSettings: SiteSettings = {
  ...
  about_mission: "",
  footer_text: "",
  footer_copyright: "© 2024 Makursite. All rights reserved.",
  social_facebook: "",
  social_twitter: "",
  social_instagram: "",
  social_youtube: "",
  ...
  seo_og_image: "",
  navbar_brand_text: "Makur",
  navbar_brand_accent: "site",
    ...
    general: [
      {
        ...
        fields: [
          { key: "site_name", label: "Site Name", type: "input", placeholder: "Makursite" },
    ...
    content: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: "footer_copyright", label: "Copyright Text", type: "input", placeholder: "© 2024 Makursite" },
        ],
      },
    ],
    contact: [
      {
        ...
        fields: [
          { key: "contact_email", label: "Contact Email", type: "input", placeholder: "contact@makursite.com", icon: Mail },
          ...
          { key: "contact_form_email", label: "Form Submission Email", type: "input", placeholder: "forms@makursite.com", icon: Mail },
        ],
      },
    ],
    social: [
