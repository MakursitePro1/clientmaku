...
export default function RandomAddressGenerator() {
  ...
  return (
    <ToolLayout title="Fake Address Generator" description={`Generate ultra-detailed random identities with addresses for ${Object.keys(countriesData).length}+ countries`}>
        ...
        <div className="tool-section-card p-3 sm:p-5 space-y-3 sm:space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            ...
            <button onClick={generate} className="tool-btn-primary flex-1 py-2.5 sm:py-3 flex items-center justify-center gap-2 text-sm sm:text-base text-primary-foreground">
              <RefreshCw className="w-4 h-4 sm:w-5 sm:h-5" /> <span className="text-primary-foreground">Generate Address</span>
            </button>
          </div>
        </div>
