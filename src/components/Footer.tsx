...
import { ArrowUpRight, Sparkles, Globe, Heart, Facebook, Twitter, Instagram, Youtube, Github, Linkedin, Zap, Grid3X3, Shield, ExternalLink } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative rounded-2xl sm:rounded-3xl border border-primary/[0.08] bg-gradient-to-b from-card/80 to-card/40 backdrop-blur-2xl overflow-hidden shadow-2xl shadow-primary/[0.03]">
          ...
          <div className="relative z-10 px-4 sm:px-8 lg:px-12 py-5 sm:py-8">
              ...
              <Link to="/" className="flex items-center gap-3 group shrink-0">
                <div className="relative">
                  ...
                  <img
                    ...
                    className="relative w-8 h-8 sm:w-10 sm:h-10 rounded-xl object-cover shadow-lg shadow-primary/10 ring-2 ring-primary/10 group-hover:ring-primary/25 transition-all duration-300"
                  />
                </div>
                <div>
            ...
            {/* Social Icons */}
            <div className="flex items-center justify-center gap-2.5 sm:gap-3 mt-6">
              {socialConfig.map((s) => {
