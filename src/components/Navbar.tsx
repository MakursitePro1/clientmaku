    ...
    <nav className="fixed inset-x-0 top-0 z-50 w-full max-w-full overflow-x-clip">
      ...
      <div className="w-full px-2 sm:px-4 lg:px-8 pt-2 sm:pt-3 lg:pt-4 box-border">
        ...
        >
          ...
          {/* Desktop Nav Links */}
          <div className={cn("items-center gap-1 bg-foreground/5 rounded-xl px-2 py-1 relative z-10 border border-foreground/5 mx-auto hidden lg:flex", isCompactNav ? "!hidden" : "")}>
            {navLinks.map((link) => (
              <button
                key={link.name}
              ...
              <div className="relative">
                ...
                >
                  <div className="relative">
                    ...
                    <Avatar className="w-8 h-8 relative border-2 border-foreground/20 group-hover:border-foreground/40 transition-colors">
              ...
              {user ? (
                <div className="space-y-1">
                  <button
                    ...
                    className="w-full text-left px-4 py-3 rounded-lg text-foreground/60 hover:text-foreground hover:bg-foreground/5 transition-all flex items-center gap-2"
                  >
